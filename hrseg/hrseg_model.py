...
from hrseg_lib.datasets.pascal_ctx import PASCALContext
...
def create_hrnet():
    args = {}
    args['cfg'] = 'path/to/hrseg/hrseg_lib/pascal_ctx/seg_hrnet_w48_cls59_480x480_sgd_lr4e-3_wd1e-4_bs_16_epoch200.yaml'
    args['opt'] = []
    ...
    pretrained_dict = torch.load('path/to/hrnet_pascal_ctx_5410_torch11.pth')
